...
public class DevProfile extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(DevProfile.this).load(mDevelopersImageUrl).into(image);
        Glide.with(DevProfile.this).load(mDevelopersImageUrl).into(mHeaderImageView);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.shareFloatingBar:
                ...
                Intent shareIntent = ShareCompat.IntentBuilder.from(DevProfile.this)
                        .setType("text/plain")
                        .setText(shareText)
                        .getIntent();
