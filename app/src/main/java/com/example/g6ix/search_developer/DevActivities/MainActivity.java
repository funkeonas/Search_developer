...
import com.example.g6ix.search_developer.Utilities.DeveloperJsonUtils;
import com.example.g6ix.search_developer.Utilities.NetworkUtil;

import org.json.JSONException;

import java.net.URL;

import static com.example.g6ix.search_developer.Utilities.NetworkUtil.isConnected;
...
private void showDevelopersList(String data) {
        ...
        try {
        mDeveloperAdapter = new DevelopersAdapter(MainActivity.this, DeveloperJsonUtils.getDevelopers(data), mViewType);
...
public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        mDevelopersRecyclerView.setAdapter(null);
        try {
        mDeveloperAdapter = new DevelopersAdapter(MainActivity.this, DeveloperJsonUtils.getDevelopers(mData), mViewType);
        if (mViewType == Integer.parseInt(getString(R.string.pref_view_grid_value))) {
        mDevelopersRecyclerView.setLayoutManager(new GridLayoutManager(this, 2));
        } else if (mViewType == Integer.parseInt(getString(R.string.pref_view_list_value))) {
        mDevelopersRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
